#' suncalc Sunrise and sunset times for a point (lat/lon)
...
#' @param d is the day of year
#' @param Lat is latitude in decimal degrees
#' @param Long is longitude in decimal degrees (negative == West)
#' @return a vector of bearings from adjacent points
#' @examples
#' suncalc(d=data$jDate,Lat=48.1442,Long=-122.7551)
#'
#' @export
suncalc<-function(d=data$jDate,Lat=48.1442,Long=-122.7551){
